 ...
 *
 * Request body per MeF WSDL:
 *   <GetAcknowledgementsRequest xmlns="...MeFMSIServices.xsd">
 *     <SubmissionIdList>
 *       <SubmissionId>11000520260500167tyb</SubmissionId>
 *       ...
 *     </SubmissionIdList>
...
function buildGetAcknowledgementsEnvelope({
  ...
  const submissionIdListXml = submissionIds
  ...
  const envelope =
    ...
    `<SubmissionIdList>${submissionIdListXml}</SubmissionIdList>` +
    `</GetAcknowledgementsRequest>` +
    `</Body>` +
    `</Envelope>`;
