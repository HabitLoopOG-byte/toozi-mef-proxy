 ...
 */
async function getAcknowledgements({ submissionIds }) {
  ...
  console.log(
    ...
    `(ensureSamlAssertion took ${ensureDurationMs}ms) submissionIds=${submissionIds.length}`
  );
  ...
  logSoap(`GET_ACKS REQUEST (messageId=${messageId}, submissionIds=${submissionIds.length})`, envelope);
