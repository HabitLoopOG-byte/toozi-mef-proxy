...
const GET_ACKS_ENDPOINT_VARIANTS = {
  // Per IRS operator guidance: the ATS GetAcknowledgements binding lives on
  // the same /mime/ base path as SendSubmissions. Same MIME multipart
  // transport contract as well — request must be multipart/related with
  // the SOAP envelope as Part 1, and responses come back the same way.
  'mime':              `${ATS_BASE}/mime/GetAcknowledgements`,            // Pub 5830 §4.3.7 (default)
  'direct':            `${ATS_BASE}/GetAcknowledgements`,                 // plain SOAP binding (Lorem Ipsum'd)
